describe('Search Users', function(){
    ...
    /* check to see that your page title is correct, that the button exists, and that the button text is correct */
    ...
    /* test what happens when you simulate clicking the search button */
